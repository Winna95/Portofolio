...
const projectFour = {
    ...
    decription: "A prototype that im currently working on in my spare time. It's for a imagionary fashion magazine for men and woman, and it shows both clothes and accessories. I have only made the design for desktop so for.",
    img: "images/dominik-kielbasa-ssnCzNayHC4-unsplash.jpg",
    imgTwo: "images/Skjermbilde 2023-07-19 134334.png",
    imgThree: "images/Skjermbilde 2023-07-19 134358.png",
    imgFour: "images/Skjermbilde 2023-07-19 134458.png",
    imgFive: "images/Skjermbilde 2023-07-19 134518.png",
...
const projectFive = {
    ...
    decription: "A prototype that im currently working on in my spare time. It's for a imagionary travel app. The app is shows luxury trailor-made trips to different places in the world.",
    img: "images/saud-edum-Mk-iBDS4CS0-unsplash.jpg",
    imgTwo: "images/Skjermbilde 2023-07-19 140239.png",
    imgThree: "images/Skjermbilde 2023-07-19 140257.png",
    imgFour: "images/Skjermbilde 2023-07-19 140313.png",
...
function getSpareTimeProjectById(id) {
    return spareTimeProjects.find(thisProduct => thisProduct.id === parseInt(id));
}
